...
namespace JFramework.Logger
{
    internal class DebugMemory
    {
        ...
        public void ExtendMemoryGUI()
        {
            ...
            GUILayout.Label(debugData.GetData("Memory Information"), GUIStyles.Label,  GUIStyles.MinHeight);
            ...
            GUILayout.Label(debugData.GetData("Total Memory") + ": " + memory + "MB        " + "[" + debugData.GetData("Min") + ": " + minTotalReservedMemory + "  " + debugData.GetData("Max") + ": " + maxTotalReservedMemory + "]", GUIStyles.Label);
            ...
            GUILayout.Label(debugData.GetData("Used Memory") + ": " + memory + "MB        " + "[" + debugData.GetData("Min") + ": " + minTotalAllocatedMemory + "  " + debugData.GetData("Max") + ": " + maxTotalAllocatedMemory + "]", GUIStyles.Label);
            ...
            GUILayout.Label(debugData.GetData("Free Memory") + ": " + memory + "MB        " + "[" + debugData.GetData("Min") + ": " + minTotalUnusedReservedMemory + "  " + debugData.GetData("Max") + ": " + maxTotalUnusedReservedMemory + "]", GUIStyles.Label);
            ...
            GUILayout.Label(debugData.GetData("Total Mono Memory") + ": " + memory + "MB        " + "[" + debugData.GetData("Min") + ": " + minMonoHeapSize + "  " + debugData.GetData("Max") + ": " + maxMonoHeapSize + "]", GUIStyles.Label);
            ...
            GUILayout.Label(debugData.GetData("Used Mono Memory") + ": " + memory + "MB        " + "[" + debugData.GetData("Min") + ": " + minMonoUsedSize + "  " + debugData.GetData("Max") + ": " + maxMonoUsedSize + "]", GUIStyles.Label);
            GUILayout.EndVertical();

            GUILayout.BeginHorizontal();
            if (GUILayout.Button(debugData.GetData("Uninstall unused resources"), GUIStyles.Button, GUIStyles.MinHeight))
            {
                Resources.UnloadUnusedAssets();
            }

            if (GUILayout.Button(debugData.GetData("Garbage Collection"), GUIStyles.Button, GUIStyles.MinHeight))
            {
                GC.Collect();
            }
