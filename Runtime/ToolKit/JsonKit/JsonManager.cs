...
namespace JFramework
{
    ...
    public sealed partial class GlobalManager
    {
        ...
        /// Json管理器
        /// </summary>
        public sealed class JsonManager : Controller
        {
            /// <summary>
            /// 存储加密密钥的字典
            /// </summary>
            ...
            /// <param name="obj">保存的数据</param>
            /// <param name="name">保存的名称</param>
            public void Encrypt(object obj, string name)
            {
                var filePath = GetPath(name);
                var saveJson = JsonUtility.ToJson(obj);
            ...
            internal void Load(ScriptableObject obj)
            {
            ...
            /// </summary>
            /// <param name="obj">加载的数据</param>
            internal void Decrypt(ScriptableObject obj)
            {
                var filePath = GetPath(obj.name);
                if (!File.Exists(filePath))
                {
