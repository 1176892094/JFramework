...
namespace JFramework
{
    public sealed partial class GlobalManager
    {
        ...
        /// 计时器管理器
        /// </summary>
        public sealed class TimerManager : Controller
        {
            /// <summary>
            /// 存储已经完成的计时器
            /// </summary>
            [ShowInInspector] private readonly Queue<Timer> queues = new Queue<Timer>();

            /// <summary>
            /// 存储正在执行的计时器
            /// </summary>
            [ShowInInspector] private readonly LinkedList<Timer> timers = new LinkedList<Timer>();
