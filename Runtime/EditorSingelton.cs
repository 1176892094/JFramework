...
namespace JFramework
{
    public abstract class EditorSingleton<T> : ScriptableObject where T : EditorSingleton<T>
    {
        ...
        private static string filePath => Common.GlobalSetting.EditorPath + "/" + fileName + ".asset";
        ...
        public static T Instance
        {
            get
            {
                ...
                if (!Directory.Exists(Common.GlobalSetting.EditorPath))
                {
                    Directory.CreateDirectory(Common.GlobalSetting.EditorPath);
                }
