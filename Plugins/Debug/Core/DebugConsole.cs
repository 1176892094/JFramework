...
namespace JFramework
{
    internal class DebugConsole
    {
        ...
        public DebugConsole(DebugSetting setting) => this.setting = setting;
        ...
        public void ExtendConsoleGUI()
        {
            ...
            if (GUILayout.Button(setting.GetData("Clear"), DebugStyle.Button, DebugStyle.MinHeight))
            {
                logList.Clear();
                logIndex = -1;
                logInfo = 0;
            ...
            if (GUILayout.Button(setting.GetData("Log") + " [" + logInfo + "]", DebugStyle.Button,
            ...
            if (GUILayout.Button(setting.GetData("Warning") + " [" + logWarn + "]", DebugStyle.Button,
                    DebugStyle.MinHeight))
            {
            ...
            if (GUILayout.Button(setting.GetData("Exception") + " [" + logException + "]", DebugStyle.Button,
                    DebugStyle.MinHeight))
            {
            ...
            if (GUILayout.Button(setting.GetData("Error") + " [" + logError + "]", DebugStyle.Button,
                    DebugStyle.MinHeight))
            {
            ...
            if (GUILayout.Button(setting.GetData("Fatal") + " [" + logFatal + "]", DebugStyle.Button,
                    DebugStyle.MinHeight))
            {
