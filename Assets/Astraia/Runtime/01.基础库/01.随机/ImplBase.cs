    ...
    public static partial class Service
    {
        public static partial class Random
        {
            ...
            private abstract class ImplBase
            {
                ...
                {
                    ulong randomProduct = MathHelpers.BigMul(maxValue, xoshiro.NextUInt64(), out ulong lowPart);
                    ...
                    if (lowPart < maxValue)
                    {
                        ...
                        while (lowPart < remainder)
                        {
                            randomProduct = MathHelpers.BigMul(maxValue, xoshiro.NextUInt64(), out lowPart);
                        }
                    }
