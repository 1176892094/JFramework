...
namespace Astraia
{
    public static partial class Service
    {
        public static partial class Random
        {
            ...
            /// </summary>
            private sealed class XoshiroImpl : ImplBase
            {
                ...
                public unsafe XoshiroImpl()
                {
                    ...
                    Span<byte> buffer = MemoryMarshal.CreateSpan(ref *(byte*)ptr, 32);
                ...
                [MethodImpl(MethodImplOptions
                    .AggressiveInlining)] // small-ish hot path used by a handful of "next" methods
                internal ulong NextUInt64()
                {
                    ulong s0 = _s0, s1 = _s1, s2 = _s2, s3 = _s3;

                    ulong result = BitOperationsHelpers.RotateLeft(s1 * 5, 7) * 9;
                    ulong t = s1 << 17;
                    ...
                    s2 ^= t;
                    s3 = BitOperationsHelpers.RotateLeft(s3, 45);
                ...
                public override unsafe void NextBytes(Span<byte> buffer)
                {
                    ...
                    {
                        ulong value = BitOperationsHelpers.RotateLeft(s1 * 5, 7) * 9;
                    ...
                    if (!buffer.IsEmpty)
                    {
                        ulong next = BitOperationsHelpers.RotateLeft(s1 * 5, 7) * 9;
